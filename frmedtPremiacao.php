            ...
            <div class="row">
                <form action="edtPremiacao.php" method="POST" id="frmedtPremiacao" class="col s12">
                    ...
                    <div class="input-field col s8">
                        ...
                        <input type="number" class="form-control" id="txtPremiacao" name="txtPremiacao" value="<?php echo $colocacao ?>">
                    </div>

                    <div class="input-field col s5">
                        <label for="lblPescador">Informe o Nome do Pescador: </label>
                        <input type="text" class="form-control" id="txtPescador" name="txtPescador" value="<?php echo $pescador ?>">
                    </div>

                    <div class="input-field col s5">
                        <label for="lblPremio">Informe o Prêmio: </label>
                        <input type="text" class="form-control" id="txtPremio" name="txtPremio" value="<?php echo $premio ?>">
                    </div>
