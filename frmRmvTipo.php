...
$sql = "SELECT * FROM tipo WHERE id=?;"; //o ? indica uma argumento para o sql
...
<head>
    ...
    <title>Remoção de Tipo do Peixe</title>
</head>
    ...
    <body bgcolor="add8e6">
        ...
        <div class="container grey lighten-4 col s12">
            <div class="blue lighten-5 col s12">
                <h3>Remover Tipo de Peixe</h3>
            </div>
            <form action="rmvTipo.php" method="POST" id='frmRmvTipo' class="col s12">
                <div class="row">
                    <div class="col s10">
                        <label for="lblId">
                            <h4>
                        ...
                        <label for="lblDescricao">
                            <H4>Descrição: <?php echo $tipo['descricao']; ?></H4>
                        </label>
                        <label for="lblEspecie">
