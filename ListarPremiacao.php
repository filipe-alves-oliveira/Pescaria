...
<meta charset="UTF-8">
   ...
   <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <div class="row">
        <div class="col s12">
        <h3 class="blue lighten-4">Listar Premiação <a class="btn-floating btn-large waves-effect waves-light green"
        ...
        <table class="striped highlight  white lighten-3 responsive-table">
            ...
            <?php 
                foreach ($listaPremiacao as $premiacao){
            ?>
                <tr>
                    <td><?php echo $premiacao['id'];?></td>
                    <td><?php echo $premiacao['colocacao'];?></td>
                    <td><?php echo $premiacao['pescador'];?></td>
                    <td><?php echo $premiacao['premio'];?></td>

                    <td><a class="btn-floating btn-small waves-effect waves-light orange"
                          onclick="JavaScript:location.href='frmedtPremiacao.php?id=' +
                          <?php echo $premiacao['id'];?>">
                           <i class="material-icons">edit</i>
                    </td>

                    <td><a class="btn-floating btn-small waves-effect waves-light red"
                          onclick="JavaScript:location.href='frmrmvPremiacao.php?id=' +
                          <?php echo $premiacao['id'];?>" >
