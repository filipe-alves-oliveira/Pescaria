...
<body>
  ...
  <body bgcolor="add8e6">
    ...
    <div class="row">
      <div class="col s12">
        <h3 class="white lighten-4">Listar Peixe <a class="btn-floating btn-large waves-effect waves-light green" onclick="JavaScript:location.href='frmInsPeixe.php'"><i class="material-icons">add</i></a>
        </h3>
            ...
            <table class="striped highlight  white lighten-3 responsive-table">
              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn-floating btn-small waves-effect waves-light orange" onclick="JavaScript:location.href='frmedtPeixe.php?id=' +
                          <?php echo $peixe['id']; ?>">
                      <i class="material-icons">edit</i>
                  </td>

                  <td><a class="btn-floating btn-small waves-effect waves-light red" onclick="JavaScript:location.href='frmrmvPeixe.php?id=' +
                          <?php echo $peixe['id']; ?>">
